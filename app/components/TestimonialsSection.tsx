...
const testimonials = [
  ...
  },
  {
    ...
    bike: "Royal Enfield Himalayan",
    route: "Désert Agafay",
    text: "The Agafay desert at sunrise on the Himalayan was the single best experience of my Morocco trip. Zero traffic, just rocks and light. MenaraRide had the GPS loaded with the exact track — I never had to look at my phone.",
  },
  {
    name: "Mathis D.",
    country: "Belgique 🇧🇪",
    ...
    <section id="testimonials" className="section overflow-clip" style={{ background: "var(--color-night)" }}>
      ...
      <div className="container">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <a href="https://g.page/r/menararide-marrakech/review" target="_blank" rel="noopener noreferrer"
